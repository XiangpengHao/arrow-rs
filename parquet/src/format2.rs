...
use crate::format_index::{ColumnChunkCursor, ColumnMetaDataCursor, SchemaElementCursor};
...
impl FieldRepetitionType {
    ...
    pub const ENUM_VALUES: &'static [Self] = &[Self::REQUIRED, Self::OPTIONAL, Self::REPEATED];
}
...
impl BoundaryOrder {
    ...
    pub const ENUM_VALUES: &'static [Self] = &[Self::UNORDERED, Self::ASCENDING, Self::DESCENDING];
}
...
impl crate::thrift::TSerializable for DataPageHeader {
    fn read_from_in_protocol<T: TInputProtocol>(i_prot: &mut T) -> thrift::Result<DataPageHeader> {
        ...
        let ret = DataPageHeader {
            ...
            encoding: f_2
                .expect("auto-generated code should have checked for presence of required fields"),
            definition_level_encoding: f_3
                .expect("auto-generated code should have checked for presence of required fields"),
            repetition_level_encoding: f_4
                .expect("auto-generated code should have checked for presence of required fields"),
            statistics: f_5,
        };
        Ok(ret)
...
impl crate::thrift::TSerializable for DataPageHeaderV2 {
    fn read_from_in_protocol<T: TInputProtocol>(
        ...
        let ret = DataPageHeaderV2 {
            ...
            encoding: f_4
                .expect("auto-generated code should have checked for presence of required fields"),
            definition_levels_byte_length: f_5
                .expect("auto-generated code should have checked for presence of required fields"),
            repetition_levels_byte_length: f_6
                .expect("auto-generated code should have checked for presence of required fields"),
            is_compressed: f_7,
            statistics: f_8,
        };
...
impl crate::thrift::TSerializable for PageHeader {
    fn read_from_in_protocol<T: TInputProtocol>(i_prot: &mut T) -> thrift::Result<PageHeader> {
        ...
        let ret = PageHeader {
            type_: f_1
                .expect("auto-generated code should have checked for presence of required fields"),
            uncompressed_page_size: f_2
                .expect("auto-generated code should have checked for presence of required fields"),
            compressed_page_size: f_3
                .expect("auto-generated code should have checked for presence of required fields"),
            crc: f_4,
...
impl ColumnMetaData {
    pub fn new<F8, F10, F11, F12, F13, F14, F15>(
        type_: Type,
    ...
    where
        ...
        F10: Into<Option<i64>>,
        F11: Into<Option<i64>>,
        F12: Into<Option<Box<Statistics>>>,
...
impl crate::thrift::TSerializable for ColumnMetaData {
    fn read_from_in_protocol<T: TInputProtocol>(i_prot: &mut T) -> thrift::Result<ColumnMetaData> {
        ...
        let ret = ColumnMetaData {
            ...
            num_values: f_5
                .expect("auto-generated code should have checked for presence of required fields"),
            total_uncompressed_size: f_6
                .expect("auto-generated code should have checked for presence of required fields"),
            total_compressed_size: f_7
                .expect("auto-generated code should have checked for presence of required fields"),
            key_value_metadata: f_8,
            data_page_offset: f_9
                .expect("auto-generated code should have checked for presence of required fields"),
...
impl EncryptionWithColumnKey {
    pub fn new<F2>(path_in_schema: Vec<String>, key_metadata: F2) -> EncryptionWithColumnKey
    where
        F2: Into<Option<Vec<u8>>>,
    {
        EncryptionWithColumnKey {
...
pub struct ColumnChunk {
    ...
    /// metadata.
    ///
    pub meta_data: Option<ColumnMetaDataCursor>,
...
impl crate::thrift::TSerializable for ColumnChunk {
    fn read_from_in_protocol<T: TInputProtocol>(i_prot: &mut T) -> thrift::Result<ColumnChunk> {
        ...
        let mut f_3: Option<ColumnMetaDataCursor> = None;
        let mut f_4: Option<i64> = None;
        let mut f_5: Option<i32> = None;
        let mut f_6: Option<i64> = None;
        let mut f_7: Option<i32> = None;
        ...
        loop {
            ...
            match field_id {
                ...
                3 => {
                    let val = ColumnMetaDataCursor::read_from_in_protocol(i_prot)?;
                    f_3 = Some(val);
                }
                4 => {
                    let val = i_prot.read_i64()?;
...
pub struct RowGroup {
    ...
    ///
    pub columns: Vec<ColumnChunkCursor>,
...
impl crate::thrift::TSerializable for RowGroup {
    fn read_from_in_protocol<T: TInputProtocol>(i_prot: &mut T) -> thrift::Result<RowGroup> {
        i_prot.read_struct_begin()?;
        let mut f_1: Option<Vec<ColumnChunkCursor>> = None;
        let mut f_2: Option<i64> = None;
        let mut f_3: Option<i64> = None;
        ...
        loop {
            ...
            match field_id {
                1 => {
                    let list_ident = i_prot.read_list_begin()?;
                    let mut val: Vec<ColumnChunkCursor> =
                        Vec::with_capacity(list_ident.size as usize);
                    for _ in 0..list_ident.size {
                        let list_elem_5 = ColumnChunkCursor::read_from_in_protocol(i_prot)?;
...
impl crate::thrift::TSerializable for OffsetIndex {
    ...
    fn write_to_out_protocol<T: TOutputProtocol>(&self, o_prot: &mut T) -> thrift::Result<()> {
        ...
        o_prot.write_list_begin(&TListIdentifier::new(
            TType::Struct,
            self.page_locations.len() as i32,
        ))?;
...
pub struct FileMetaData {
    ...
    pub schema: Vec<SchemaElementCursor>,
...
impl crate::thrift::TSerializable for FileMetaData {
    fn read_from_in_protocol<T: TInputProtocol>(i_prot: &mut T) -> thrift::Result<FileMetaData> {
        i_prot.read_struct_begin()?;
        let mut f_1: Option<i32> = None;
        let mut f_2: Option<Vec<SchemaElementCursor>> = None;
        let mut f_3: Option<i64> = None;
        ...
        loop {
            ...
            match field_id {
                ...
                2 => {
                    let list_ident = i_prot.read_list_begin()?;
                    let mut val: Vec<SchemaElementCursor> =
                        Vec::with_capacity(list_ident.size as usize);
                    for _ in 0..list_ident.size {
                        let list_elem_12 = SchemaElementCursor::read_from_in_protocol(i_prot)?;
